    ...
    [774], {
        7171: (e, t, s) => {
                ...
                p = function() {
                    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Object.is,
                        ...
                        g = arguments.length > 8 && void 0 !== arguments[8] ? arguments[8] : n => {
                            ...
                            return c.set(O, W), Reflect.ownKeys(n).forEach((e => {
            ...
            const P = {
                ...
                getWalletImageUrl: e => "".concat(k, "/w3m/v1/getWalletImage/").concat(e, "?projectId=").concat(O.state.projectId, "&sdkType=").concat(M, "&sdkVersion=").concat(U),
                getAssetImageUrl: e => "".concat(k, "/w3m/v1/getAssetImage/").concat(e, "?projectId=").concat(O.state.projectId, "&sdkType=").concat(M, "&sdkVersion=").concat(U)
            };
            ...
            const _ = b.isMobile(),
                    ...
                    async getRecomendedWallets() {
                        ...
                        if (b.isArray(e)) {
                            ...
                            const {
                                chains: e,
                                isAuth: s
                            } = I.state, o = null === e || void 0 === e ? void 0 : e.join(","), n = b.isArray(t), a = {
                                page: 1,
                ...
                K = {
                    ...
                    open: async e => new Promise((t => {
                        ...
                        if (b.removeWalletConnectDeepLink(), I.setWalletConnectUri(null === e || void 0 === e ? void 0 : e.uri), I.setChains(null === e || void 0 === e ? void 0 : e.chains), m.reset("ConnectWallet"), s && o) H.open = !0, t();
                        else {
                            const e = setInterval((() => {
                                const s = I.state;
            ...
            const Q = h({
                ...
                X = {
                    ...
                    setThemeConfig(e) {
                        ...
                        t && (Q.themeMode = t), s && (Q.themeVariables = ((e, t) => {
        ...
        774: (e, t, s) => {
            ...
            class n {
                constructor(e) {
                    this.openModal = o.jb.open, this.closeModal = o.jb.close, this.subscribeModal = o.jb.subscribe, this.setTheme = o.ThemeCtrl.setThemeConfig, o.ThemeCtrl.setThemeConfig(e), o.ConfigCtrl.setConfig(e), this.initUi()
                }
                async initUi() {
                    if (typeof window < "u") {
                        await s.e(3459).then(s.bind(s, 3459));
...
//# sourceMappingURL=774.e417635d.chunk.js.map
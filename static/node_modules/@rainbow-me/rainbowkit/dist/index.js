...
import {
    createMapValueFn as _51c72
} from "@vanilla-extract/sprinkles/createUtils";
import {
    createNormalizeValueFn as _a49f6
} from "@vanilla-extract/sprinkles/createUtils";
import {
    createSprinkles as _ad221
} from "@vanilla-extract/sprinkles/createRuntimeSprinkles";
...
var EmojiAvatar = ({
    ...
    const {
        ...
        emoji
    } = useMemo3(() => emojiAvatarForAddress(address), [address]);
...
var fetchTranslations = async (locale) => {
    switch (locale) {
        ...
        case "ar-AR":
            return (await
                import ("./ar_AR-JMD66B7M.js")).default;
        case "en":
        case "en-US":
            return (await
                import ("./en_US-YCSC4K5L.js")).default;
        case "es":
        case "es-419":
            return (await
                import ("./es_419-RQ6VJ2M7.js")).default;
        case "fr":
        case "fr-FR":
            return (await
                import ("./fr_FR-TUWWS2DE.js")).default;
        case "hi":
        case "hi-IN":
            return (await
                import ("./hi_IN-36H5CP3S.js")).default;
        case "id":
        case "id-ID":
            return (await
                import ("./id_ID-W5UHAYHB.js")).default;
        case "ja":
        case "ja-JP":
            return (await
                import ("./ja_JP-KK2NXWRS.js")).default;
        case "ko":
        case "ko-KR":
            return (await
                import ("./ko_KR-KMTJD4T2.js")).default;
        case "pt":
        case "pt-BR":
            return (await
                import ("./pt_BR-GW426R6L.js")).default;
        case "ru":
        case "ru-RU":
            return (await
                import ("./ru_RU-HTQBJLOS.js")).default;
        case "th":
        case "th-TH":
            return (await
                import ("./th_TH-MJ4F4ECT.js")).default;
        case "tr":
        case "tr-TR":
            return (await
                import ("./tr_TR-PWB7ALIV.js")).default;
        case "ua":
        case "uk-UA":
            return (await
                import ("./uk_UA-THPZGENO.js")).default;
        case "zh":
        case "zh-CN":
            return (await
                import ("./zh_CN-HB5SXCVK.js")).default;
        default:
            return (await
                import ("./en_US-YCSC4K5L.js")).default;
    }
...
var arbitrumIcon = {
    ...
    iconUrl: async () => (await
        import ("./arbitrum-LYDBJZP3.js")).default
};
var avalancheIcon = {
    iconBackground: "#e84141",
    iconUrl: async () => (await
        import ("./avalanche-TFPKP544.js")).default
};
var baseIcon = {
    iconBackground: "#0052ff",
    iconUrl: async () => (await
        import ("./base-3MIUIYGA.js")).default
};
var bscIcon = {
    iconBackground: "#ebac0e",
    iconUrl: async () => (await
        import ("./bsc-S2GSW6VX.js")).default
};
var cronosIcon = {
    iconBackground: "#002D74",
    iconUrl: async () => (await
        import ("./cronos-DQKKIEX7.js")).default
};
var ethereumIcon = {
    iconBackground: "#484c50",
    iconUrl: async () => (await
        import ("./ethereum-4FY57XJF.js")).default
};
var hardhatIcon = {
    iconBackground: "#f9f7ec",
    iconUrl: async () => (await
        import ("./hardhat-ARRFHFKB.js")).default
};
var optimismIcon = {
    iconBackground: "#ff5a57",
    iconUrl: async () => (await
        import ("./optimism-UUP5Y7TB.js")).default
};
var polygonIcon = {
    iconBackground: "#9f71ec",
    iconUrl: async () => (await
        import ("./polygon-Z4QITDL7.js")).default
};
var xdcIcon = {
    iconBackground: "#f9f7ec",
    iconUrl: async () => (await
        import ("./xdc-5UHQ25DW.js")).default
};
var zkSyncIcon = {
    iconBackground: "#f9f7ec",
    iconUrl: async () => (await
        import ("./zkSync-XRUC4ZHO.js")).default
};
var zoraIcon = {
    iconBackground: "#000000",
    iconUrl: async () => (await
        import ("./zora-KVO7WIOK.js")).default
};
...
import {
    ...
    usePublicClient as usePublicClient2
} from "wagmi";
...
function createTransactionStore({
    ...
    function setTransactionStatus(account, chainId, hash, status) {
        updateTransactions(account, chainId, (transactions) => {
            return transactions.map((transaction) => transaction.hash === hash ? { ...transaction,
                status
            } : transaction);
        });
    }
    ...
    function updateTransactions(account, chainId, updateFn) {
        ...
        const transactions = updateFn((_b = data[account][chainId]) != null ? _b : []).filter(({
            status
        }) => {
...
function TransactionStoreProvider({
    ...
    const [store] = useState5(() => storeSingleton != null ? storeSingleton : storeSingleton = createTransactionStore({
        provider
    }));
    useEffect6(() => {
...
function ModalSizeProvider({
    ...
    const {
        connector
    } = useContext6(WalletButtonContext);
...
function useWalletConnectors() {
    ...
    async function connectWallet(walletId, connector) {
        ...
        const result = await connectAsync({
            chainId: (_c = intialChainId != null ? intialChainId : (_a2 = rainbowKitChains.find(({
                id
            }) => id === walletChainId)) == null ? void 0 : _a2.id) != null ? _c : (_b = rainbowKitChains[0]) == null ? void 0 : _b.id,
            connector
        });
        if (result) {
    ...
    for (const wallet of groupedWallets) {
        ...
        walletConnectors.push({
            ...
            onConnecting: (fn) => wallet.connector.on("message", ({
                type
...
var src = async () => (await
    import ("./assets-26YY4GVD.js")).default;
...
var src2 = async () => (await
    import ("./login-ZSMM5UYL.js")).default;
...
// src/components/SignIn/SignIn.tsx
var signInIcon = async () => (await
    import ("./sign-FZVB2CS6.js")).default;
...
function TxList({
    ...
    const {
        appName
    } = useContext10(AppContext);
    const {
        i18n: i18n2
    } = useContext10(I18nContext);
...
var MenuButton = React39.forwardRef(({
    ...
    return /* @__PURE__ */ React39.createElement(Box, {
        ...
        borderRadius: "menuButton",
        className: [
            mobile ? unsetBackgroundOnHover : void 0, !currentlySelected && touchableStyles({
                active: "shrink"
            })
        ],
        padding: mobile ? "8" : "6",
...
function ConnectModalIntro({
    ...
    const {
        ...
        learnMoreUrl
    } = useContext13(AppContext);
    const {
        i18n: i18n2
    } = useContext13(I18nContext);
...
var src3 = async () => (await
    import ("./connect-XNDTNVUH.js")).default;
...
var src4 = async () => (await
    import ("./create-PAJXJDV3.js")).default;
...
var src5 = async () => (await
    import ("./refresh-5KGGHTJP.js")).default;
...
var src6 = async () => (await
    import ("./scan-HZBLXLM4.js")).default;
...
var getBrowserSrc = async () => {
    ...
    switch (browser) {
        case "Arc" /* Arc */ :
            return (await
                import ("./Arc-QDJFTGH2.js")).default;
        case "Brave" /* Brave */ :
            return (await
                import ("./Brave-YATE5BIM.js")).default;
        case "Chrome" /* Chrome */ :
            return (await
                import ("./Chrome-LGF33C3S.js")).default;
        case "Edge" /* Edge */ :
            return (await
                import ("./Edge-K2JEGI5S.js")).default;
        case "Firefox" /* Firefox */ :
            return (await
                import ("./Firefox-NP5SYEK5.js")).default;
        case "Opera" /* Opera */ :
            return (await
                import ("./Opera-KV54PXPA.js")).default;
        case "Safari" /* Safari */ :
            return (await
                import ("./Safari-2QIYKJ4P.js")).default;
        default:
            return (await
                import ("./Browser-HN7O5MN7.js")).default;
    }
};
...
var getPlatformSrc = async () => {
    ...
    switch (platform) {
        case "Windows" /* Windows */ :
            return (await
                import ("./Windows-R3CKAIUV.js")).default;
        case "macOS" /* MacOS */ :
            return (await
                import ("./Macos-2KTZ2XLP.js")).default;
        case "Linux" /* Linux */ :
            return (await
                import ("./Linux-NS2LQPT4.js")).default;
        default:
            return (await
                import ("./Linux-NS2LQPT4.js")).default;
    }
...
function DesktopOptions({
    ...
    const {
        disclaimer: Disclaimer
    } = useContext17(AppContext);
    const {
        i18n: i18n2
    } = useContext17(I18nContext);
    const initialized = useRef5(false);
    const {
        connector
    } = useContext17(WalletButtonContext);
...
var MobileStatus = ({
    ...
    const {
        connector
    } = useContext19(WalletButtonContext);
    const {
        i18n: i18n2
...
function ConnectOptions({
    ...
    const {
        connector
    } = useContext20(WalletButtonContext);
...
function WalletButtonRenderer({
    ...
    const {
        connector,
        setConnector
    } = useContext24(WalletButtonContext);
...
var braveWallet = ({
    ...
    return {
        ...
        name: "Brave Wallet",
        iconUrl: async () => (await
            import ("./braveWallet-BTBH4MDN.js")).default,
        iconBackground: "#fff",
...
import {
    InjectedConnector as InjectedConnector2
} from "wagmi/connectors/injected";
...
var coinbaseWallet = ({
    ...
    return {
        ...
        shortName: "Coinbase",
        iconUrl: async () => (await
            import ("./coinbaseWallet-2OUR5TUP.js")).default,
        iconAccent: "#2c5ff6",
...
import {
    InjectedConnector as InjectedConnector3
} from "wagmi/connectors/injected";
var injectedWallet = ({
    chains,
    ...options
    ...
    name: "Browser Wallet",
    iconUrl: async () => (await
        import ("./injectedWallet-EUKDEAIU.js")).default,
    iconBackground: "#fff",
    hidden: ({
        wallets
    }) => wallets.some((wallet) => wallet.installed && wallet.name === wallet.connector.name && (wallet.connector instanceof InjectedConnector3 || wallet.id === "coinbase")),
    createConnector: () => ({
...
import {
    WalletConnectConnector as WalletConnectConnector2
} from "wagmi/connectors/walletConnect";
import {
    WalletConnectLegacyConnector
} from "wagmi/connectors/walletConnectLegacy";
...
var metaMaskWallet = ({
    ...
    return {
        ...
        name: "MetaMask",
        iconUrl: async () => (await
            import ("./metaMaskWallet-ORHUNQRP.js")).default,
        iconAccent: "#f6851a",
        iconBackground: "#fff",
...
var rainbowWallet = ({
    ...
    return {
        ...
        name: "Rainbow",
        iconUrl: async () => (await
            import ("./rainbowWallet-GGU64QEI.js")).default,
...
var safeWallet = ({
    ...
    iconBackground: "#fff",
    iconUrl: async () => (await
        import ("./safeWallet-DFMLSLCR.js")).default,
...
var walletConnectWallet = ({
    ...
    name: "WalletConnect",
    iconUrl: async () => (await
        import ("./walletConnectWallet-D6ZADJM7.js")).default,

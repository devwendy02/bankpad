...
const Dropdown = ({
    ...
    role = "list"
    dropdownPosition = {
        dropdownPosition(props, methods)
    }
    selectBounds = {
        state.selectBounds
    }
    ...
    className = {
        `${LIB_NAME}-dropdown ${LIB_NAME}-dropdown-position-${dropdownPosition(
      props,
      methods
    )}`
    } > {
            ...
            React.Fragment > {
                ...
                state.searchResults.length === 0 ? ( <
                    ...
                    state.searchResults.map((item, itemIndex) => ( <
                        Item key = {
                            item[props.valueField].toString()
                        }
                        item = {
                            item
                        }
...
const DropDown = styled.div `
  ...
  ${({ selectBounds, dropdownGap, dropdownPosition }) =>
    dropdownPosition === 'top'
      ? `
bottom: $ {
    selectBounds.height + 2 + dropdownGap
}
px `
      : `
top: $ {
